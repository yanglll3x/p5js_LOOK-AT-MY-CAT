...
const bg_color = [136,153,199];//blue
...
function draw () {
  ...
  if (mode == '1') {
    ...
    s5 = map(s5,0,100,0,10);
    s6 = map(s6,0,100,0,2);
    s7 = map(s7,0,100,0,10);
    s8 = map(s8,0,100,0,10);
    s9 = map(s9,0,100,0,10);
    s10 = map(s10,0,101,0,3);
  ...
  if (mode == '2') {
    ...
    s4 = map(s4,0,100,0,10);
    s5 = map(s5,0,100,0,10);
    s6 = map(s6,0,100,0,10);
    s7 = map(s7,0,100,0,10);
    s8 = map(s8,0,100,0,10);
    s9 = map(s9,0,100,0,10);
    s10 = map(s10,0,101,0,4);

    drawFace2(s1,s2,s3,s4,s5,s6,s7,s8,s9,s10);
  }
